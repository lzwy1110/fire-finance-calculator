...
export const Header: React.FC<HeaderProps> = ({
  ...
  return (
    <header className="sticky top-0 z-30 bg-[#0a0a0a]/95 backdrop-blur-md border-b border-white/10 px-3.5 lg:px-8 pt-[max(0.6rem,env(safe-area-inset-top))] pb-2.5 transition-all">
